...
var fraction_types = {
    ...
    "20": ["Не обнаружено"],
    "21": ["Скудное кол-во", "Единично"],
    "22": ["Положительно", "Отрицательно"],
    "23": ["В поле зрения"],
    "24": ["Отсутствует", "Единично"],
    "25": ["Един.", "1-3", "5-8", "10-15", "20-30", "Больш. к-во", "В поле зрения"],
    "26": ["Отсутствует", "В поле зрения"],
    "27": ["Серый", "Жёлтый", "Кровянистый", "Ржавый"],
    "28": ["Слизистый", "Гнойно-слизистый", "Слизисто-гнойный"],
    "29": ["Вязкая", "Жидкая"],
    "30": ["Обнаружено", "Не обнаружено"],
    "31": ["Мягкая", "Плотноватая", "Кашицеобразная"],
    "32": ["Оформленная", "Неоформленная"],
    "33": ["Коричневый", "Тёмно-коричневый", "Светло-коричневый", "Серовато-жёлтый", "Жёлтый"],
    "34": ["Отсутствует", "Единично", "Небольш. кол-во", "Умеренно", "Больш. кол-во"],
};
